...
// WiFi credentials
const char* ssid = "ur mom";  // Your SSID
const char* password = "ur mom";         // No password for open networks

// Server details (replace with your target server)
const char* serverUrl = "ur mom";  // Your target URL
const int serverPort = 4200;                                                   // Port for the target URL (use 443 for HTTPS)
